...
SRC_DRIVER	= ./drivers/screen.c ./drivers/mac.c ./drivers/mac_support.c
...
SRC_FS      = ./kernel/fs/fs.c ./kernel/fs/disk.c ./kernel/fs/path.c ./kernel/fs/bitmap.c ./kernel/fs/text.c

SRC_TEST    = ./test/test_fs.c ./test/edit.c
...
main : $(SRC_ARCH) $(SRC_DRIVER) $(SRC_INIT) $(SRC_INT) $(SRC_LOCK) $(SRC_SCHED) $(SRC_SYSCALL) $(SRC_LIBS) $(SRC_TEST) $(SRC_SHELL) $(SRC_MM) $(SRC_HELLO) $(SRC_FS)
	...
	$(SRC_ARCH) $(SRC_DRIVER) $(SRC_INIT) $(SRC_INT) $(SRC_LOCK) $(SRC_SCHED) $(SRC_SYSCALL) $(SRC_PROC) $(SRC_LIBS) $(SRC_TEST) $(SRC_SHELL) $(SRC_MM) $(SRC_HELLO) $(SRC_FS) -L. -lepmon -nostdlib -Wl,-m -Wl,elf32ltsmip -T ld.script		
